...
class ExtractedTextScreen extends StatefulWidget {
  ...
  const ExtractedTextScreen({super.key, required this.extractedText, this.pdfPath, this.pdfFileName});
...
class _ExtractedTextScreenState extends State<ExtractedTextScreen> {
  ...
  Future<void> _viewPdf() async {
    if (widget.pdfPath != null && widget.pdfPath!.isNotEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('No PDF file available to view')),
      );
    }
  }
            ...
            Wrap(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Share Text', style: TextStyle(fontSize: 12)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Theme.of(context).primaryColor,
                    foregroundColor: Colors.white,
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
