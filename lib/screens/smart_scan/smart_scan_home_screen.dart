                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      subtitle: const Text('Optimize for handwritten text'),
                    ...
                    // Recognition quality
                    const Text('Recognition Quality', style: TextStyle(fontWeight: FontWeight.bold)),
                    RadioListTile(
                      title: const Text('Fast'),
                      subtitle: const Text('Lower quality, faster processing'),
                      value: 1,
                    ...
                    RadioListTile(
                      ...
                      subtitle: const Text('Good quality, reasonable speed'),
                      value: 2,
                      groupValue: _recognitionQuality,
                      onChanged: (value) {
                        setState(() {
                    ...
                    RadioListTile(
                      ...
                      subtitle: const Text('Best quality, slower processing'),
                      value: 3,
                      groupValue: _recognitionQuality,
                      onChanged: (value) {
                        setState(() {
                    ...
                    SwitchListTile(
                      title: const Text('Enhanced Correction'),
                      subtitle: const Text('Apply advanced text corrections'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Enhanced Correction:'),
                        Chip(
                          label: Text(
